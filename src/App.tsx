      ...
      <div className="card" style={{ position: 'relative' }}>
        ...
        <div className="header">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '10px', marginTop: '1rem', alignItems: 'center' }}>
            {/* 새로운 주말리그용 탭 4개 */}
            <button onClick={() => handleTabChange('playerSetup')} style={{ padding: '0.6rem 1.2rem', fontSize: '0.95rem', borderRadius: '25px', border: 'none', cursor: 'pointer', fontWeight: 'bold', background: activeTab === 'playerSetup' ? 'var(--primary)' : '#E5E7EB', color: activeTab === 'playerSetup' ? 'white' : '#374151' }}>1. 선수 입력</button>
            <button onClick={() => handleTabChange('matchInput')} style={{ padding: '0.6rem 1.2rem', fontSize: '0.95rem', borderRadius: '25px', border: 'none', cursor: 'pointer', fontWeight: 'bold', background: activeTab === 'matchInput' ? 'var(--primary)' : '#E5E7EB', color: activeTab === 'matchInput' ? 'white' : '#374151' }}>2. 대진표 및 결과 입력</button>
